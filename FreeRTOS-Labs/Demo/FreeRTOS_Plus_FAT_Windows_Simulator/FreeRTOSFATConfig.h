...
connected.   NOTE!!! using Windows system calls such as printf() can cause the
FreeRTOS Win32 port to be unstable as Windows may suspend or block a thread that
should be under the control of the FreeRTOS kernel. */
#include <stdio.h>
