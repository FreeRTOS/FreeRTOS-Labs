...
Socket_t xListeningSocket;
	...
	for( ;; )
	{
		...
		cReceivedString.  By default the block time is
		ipconfigSOCK_DEFAULT_RECEIVE_BLOCK_TIME.  xClientLength is not actually
		used by FreeRTOS_recvfrom(), but is set appropriately in case future
		versions do use it. */
