...
#ifndef SEPARATE_TASK_TCP_ECHO_CLIENTS_H
#define SEPARATE_TASK_TCP_ECHO_CLIENTS_H

/*
 * Create the TCP echo client tasks.  One task uses the standard interface
...
#endif /* SEPARATE_TASK_TCP_ECHO_CLIENTS_H */
